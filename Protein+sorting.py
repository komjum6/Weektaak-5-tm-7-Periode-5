...
df_kr = KR.parse("all detected proteins", skiprows=2)
df_kr.head()
...
df_dd = DD.parse("all detected proteins", skiprows=2)
df_dd.head()
...
df_mpk3 = mpk3.parse("all detected proteins", skiprows=2)
df_mpk3.head()
...
df_mpk6 = mpk6.parse("all detected proteins", skiprows=2)
df_mpk6.head()
